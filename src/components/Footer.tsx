...
const Footer = () => {
  return (
    <footer className="bg-earth-900 text-white pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-earth-200 hover:text-white">Home</a></li>
              <li><a href="#shop" className="text-earth-200 hover:text-white">Shop</a></li>
              <li><a href="#about" className="text-earth-200 hover:text-white">About Us</a></li>
              <li><a href="#how-it-works" className="text-earth-200 hover:text-white">How It Works</a></li>
              <li><a href="#" className="text-earth-200 hover:text-white">FAQs</a></li>
            </ul>
          </div>
